...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	while (TRUE)
	{
		...
		{
			// Переводим события в правильный формат.
			TranslateMessage(&msg);

			// Передаем события в метод WindowProc.
			DispatchMessage(&msg);

			// Проверяем, не нужно ли нам выйти из цикла.
	...
	// Вернем эту часть сообщения WM_QUIT в Windows.
	return msg.wParam;
}
