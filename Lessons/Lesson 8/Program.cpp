...
void InitD3D(HWND hWnd)
{
	...
	scd.BufferDesc.Width = SCREEN_WIDTH;					// Ширина буфера
	scd.BufferDesc.Height = SCREEN_HEIGHT;					// Высота буфера
	scd.Flags = DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH;     // Разрешить переключение на полный экран
...
void CleanD3D(void)
{
	swapchain->SetFullscreenState(FALSE, NULL);    // Переход с полного экрана на оконный режим
